...
class Device {
  ...
  static Future<String?> systemVersion() async {
    if (_systemVersion == null) {
      ...
      if (data.containsKey('version.release') &&
          data['version.release'] is String) {
        _systemVersion = data['version.release'];
      } else if (data.containsKey('systemVersion') &&
          data['systemVersion'] is String) {
        _systemVersion = data['systemVersion'];
      } else if (kIsWeb) {
        _systemVersion =
            'web${data['userAgent'] is String ? '(${data['userAgent']})' : ''}';
      }
    }
  ...
  static Future<String?> deviceName() async {
    if (_deviceName == null) {
      Map<String, dynamic> data = await _data();
      if (data.containsKey('modelName') && data['modelName'] is String) {
        _deviceName = data['modelName'];
      } else if (data.containsKey('model') && data['model'] is String) {
        _deviceName = data['model'];
      } else if (kIsWeb &&
          data.containsKey('browserName') &&
          data['browserName'] is String) {
        _deviceName = data['browserName'];
      }
    }
    return _deviceName;
  }
  ...
  static Future<List<String>?> supportedAbis() async {
    final Map<String, dynamic> data = await _data();
    if (data.containsKey('supportedAbis') &&
        data['supportedAbis'] is List<String>) {
      return data['supportedAbis'];
    }
    return null;
  }
